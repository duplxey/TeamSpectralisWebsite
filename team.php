            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/Fizzy.jpg" class="avatar" alt="">
                            <h4>Fizzy</h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/Tricksy.jpg" class="avatar" alt="">
                            <h4>Tricksy</h4>
                            <div class="social">
                ...
                <div class="row">
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/swagter.jpg" class="avatar" alt="">
                            <h4>Swagter</h4>
                            <div class="social">
                ...
                <div class="row">
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            ...
                            <h4>Pircolino <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/sparke.jpg" class="avatar" alt="">
                            <h4>Sparke <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            ...
                            <h4>Dino <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            ...
                            <h4>T1rc <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            ...
                            <h4>Sparx <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/woozy.png" class="avatar" alt="">
                            <h4>Woozy <small style="font-style: italic; color:#6c757d; font-weight: bold;">(AP)</small></h4>
                            <div class="social">
                ...
                <div class="row">
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            ...
                            <h4>Swaggie <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            ...
                            <h4>Jekouc <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/kelc.png" class="avatar" alt="">
                            <h4>Kelc <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/pisoskill.png" class="avatar" alt="">
                            <h4>PisoSkill <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            ...
                            <h4>Veloxcity <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/zigyboii.jpg" class="avatar" alt="">
                            <h4>Zigyboii <small style="font-style: italic; color:#6c757d; font-weight: bold;">(FN)</small></h4>
                            <div class="social">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/ritter.jpg" class="avatar" alt="">
                            <h4>RitterČančer</h4>
                            <div class="social">
                    ...
                    <div class="col-12 col-md-3 padded-top">
                        <div class="center">
                            <img src="img/team/mato.jpg" class="avatar" alt="">
                            <h4>Mato</h4>
                            <div class="social">
